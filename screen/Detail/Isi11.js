  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Bagaimana cara edit atau membatalkan pemesanan?</Text>
          <Text style={styles.child}>Anda bisa menghubungi Customer Care kami, jika terdapat produk yang akan Anda edit atau batalkan.</Text>
          <View >
            {this.state.show ?
