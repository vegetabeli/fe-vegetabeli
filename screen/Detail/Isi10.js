  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Bagaimana saya mengecek status pemesanan saya?</Text>
          <Text style={styles.child}>Setiap Anda belanja Customer Care kami akan mengkonfirmasi terlebih dahulu ke Anda untuk memastikan belanjaan Anda siap kami belanjakan. Dan Anda bisa melihat status pesanan pada fitur Transaksi pesanan.</Text>
          <View >
            {this.state.show ?
