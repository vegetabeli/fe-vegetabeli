  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Siapa yang akan memilihkan pesanan saya?</Text>
          <Text style={styles.child}>Kami memiliki personal shopper yang akan berbelanja dan driver yang akan mengantarkan pesanan ke tempat Anda. Semua shopper dan driver kami sudah terlatih untuk memilihkan produk terbaik untuk kamu.</Text>
          <View >
            {this.state.show ?
