  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Bagaimana jika stok barang yang saya pesan habis?</Text>
          <Text style={styles.child}>Jika terdapat barang habis di Pasar Tradisional, pihak Customer Care akan menghubungi Anda baik via chat maupun telephone</Text>
          <View >
            {this.state.show ?
