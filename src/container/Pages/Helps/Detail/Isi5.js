  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Kapan saya dapat menerima pengambilan uang dari Tumbasin.id?</Text>
          <Text style={styles.child}>Pengambilan uang dilakukan saat belanjaan telah sampai di tangan anda.</Text>
          <View >
            {this.state.show ?
