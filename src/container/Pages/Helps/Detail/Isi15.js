  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Bagaimana jika saya ingin mengembalikan kantong belanja Tumbasin.id?</Text>
          <Text style={styles.child}>Kami mengimbau anda untuk mengembalikan kantong Tumbasin.id yang masih dalam kondisi baik untuk digunakan pada pembelanjaan anda berikutnya. Namun, silakan saja jika anda ingin menggunakannya untuk keperluan pribadi.</Text>
          <View >
            {this.state.show ?
