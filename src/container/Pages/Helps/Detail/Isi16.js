  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Bagaimana jika saya ingin mereturn barang?</Text>
          <Text style={styles.child}>Jika pada pesanan Anda terdapat barang yang keliru, maka Anda dapat menolak barang tersebut ketika kurir kami mengantarkannya ke rumah Anda, atau anda dapat melaporkannya ke Customer Care kami.</Text>
          <View >
            {this.state.show ?
