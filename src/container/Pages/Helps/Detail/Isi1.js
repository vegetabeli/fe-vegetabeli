  ...
  render() {
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Apa Tumbasin.id?</Text>
          <Text style={styles.child}>Tumbasin.id mengantarkan bahan makanan dan kebutuhan sehari-hari dari Pasar ke depan pintu rumah Anda. Belanja hari ini kami antar besok hari.</Text>
          <View >
            {this.state.show ?
