  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Saya punya pertanyaan lebih lanjut untuk Tumbasin.id!</Text>
          <Text style={styles.child}>Silakan hubungi kami di tumbassemarang@gmail.com atau bisa langsung menghubungi Customer Care kami ke 082242861268. Kami siap melayani anda!</Text>
          <View >
            {this.state.show ?
