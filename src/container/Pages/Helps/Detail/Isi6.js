  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Seberapa cepat Tumbasin.id mengantarkan pesanan?</Text>
          <Text style={styles.child}>Pesanan sekarang kami antar besok pagi. Batas pemesanan sampai pukul 00.00 WIB selebihnya akan dikirim lusa. Pengantaran dikirim mulai dari jam 06.00 - 10.00 pagi.</Text>
          <View >
            {this.state.show ?
