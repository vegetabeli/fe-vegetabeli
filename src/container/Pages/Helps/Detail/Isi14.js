  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Bagaimana melihat struk pembelanjaan saya?</Text>
          <Text style={styles.child}>Anda akan menerima nota belanjaan dari Tim Pengantaran kami, saat belanjaan sampai di tangan Anda.</Text>
          <View >
            {this.state.show ?
