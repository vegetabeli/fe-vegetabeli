  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Berapa ongkos kirimnya?</Text>
          <Text style={styles.child}>Ongkos kirim Tumbasin.id saat ini adalah Rp 10.000 untuk semua pengiriman di wilayah Kota Semarang.</Text>
          <View >
            {this.state.show ?
