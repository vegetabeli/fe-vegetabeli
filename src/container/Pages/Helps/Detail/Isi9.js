  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Apakah harga barang di Tumbasin.id berbeda dengan harga di Pasar Tradisional?</Text>
          <Text style={styles.child}>Harga yang terpublikasi pada situs atau aplikasi sama dengan harga pasar, dan harga dapat berubah tanpa pemberitahuan terlebih dahulu. Jika anda menemukan ada barang yang anda pikir harganya keliru, silakan hubungi kami! Kami melayani pembatan barang yang memiliki harga yang keliru dikarenakan error.</Text>
          <View >
            {this.state.show ?
