  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Operasional Tumbasin.id sudah ada di kota mana saja?</Text>
          <Text style={styles.child}>Saat ini kami melayani wilayah kota semarang</Text>
          <View >
            {this.state.show ?
        ...
        <Provider>
            <Portal>
              <Modal visible={this.state.visible} onDismiss={this.hideModal}>
                <Card style={{height:100, marginLeft:8,marginRight:8}}>
