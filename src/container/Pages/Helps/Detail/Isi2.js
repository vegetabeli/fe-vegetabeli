  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        ...
        <View >
          <Text style={styles.parent}>Pasar mana saja yang sementara bekerjasama dengan Tumbasin.id?</Text>
          <Text style={styles.child}>Pihak Tumbasin.id mengambil produk-produk dari Pasar Tradisional Karangayu. Kami secara konsisten menambah jumlah pedagang untuk menjadi mitra kami.</Text>
          <View >
            {this.state.show ?
